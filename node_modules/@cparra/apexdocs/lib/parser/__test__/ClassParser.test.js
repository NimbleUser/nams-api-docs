...
test('name line is set correctly', () => {
    const builtClassModel = new ClassParser_1.default().getClass(nameLine, commentLines, 4);
...
test('that description content was set correctly when there are multiple description line', () => {
    ...
    const builtClassModel = new ClassParser_1.default().getClass(nameLine, multiLineDescriptionComment, 4);
    expect(builtClassModel.getDescription()).toBe('This is my class description. The class description continues here. And keeps going. /');
});
