...
test('that name line is set correctly', () => {
    const builtMethodModel = new MethodParser_1.default().getMethod('ClassName', nameLine, commentLines, 4);
...
test('that method is constructor when class name is the same as the method name', () => {
    const builtMethodModel = new MethodParser_1.default().getMethod('testMethod', nameLine, commentLines, 4);
...
test('that muitiline description is set', () => {
    ...
    const builtMethodModel = new MethodParser_1.default().getMethod('ClassName', nameLine, multiLineDescriptionCommentLines, 4);
